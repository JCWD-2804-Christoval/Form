            ...
            <ul className="mt-6 space-y-2">
                {users?.map((user:any) => {
                    return (
                        <li
                            key={user?.id}
                            className="flex justify-between items-center p-4 border border-gray-300 round-md"
                        >
                            ...
                            <div className="space-x-2">
                                ...
                                className="px-4 py-2 text-white bg-green-500 hover:bg-green-600 rounded-md">Edit</button>
                                <button onClick={() => handleDelete(user?.id)}
                                className="px-4 py-2 text-white bg-green-500 hover:bg-green-600 rounded-md">Delete</button>
                            </div>
                        </li>
                    );
                })};    
